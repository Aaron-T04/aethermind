...
export default function HomeHeroBadge() {
  return (
    ...
    >
      <div className="px-8 text-label-x-small">Autonomous AI Workflow Builder</div>

      <div className="p-1">
        <div className="size-18 bg-accent-black flex-center rounded-full group-hover:bg-aethermind-blue transition-all group-hover:w-30">
          <svg
            fill="none"
            height="8"
            viewBox="0 0 10 8"
